...
namespace Inversion.Process {
	...
	public class Event : IEvent, IEnumerable<KeyValuePair<string, string>> {
		...
		private readonly ISimpleProcessContext _context;
		...
		/// </remarks>
		public ISimpleProcessContext Context {
			get {
				return _context;
			}
		}
		...
		public Event(ISimpleProcessContext context, string message, IDictionary<string, string> parameters) : this(context, message, null, parameters) { }
		...
		/// <param name="parameters">The parameters of the event.</param>
		public Event(ISimpleProcessContext context, string message, IData obj, IDictionary<string, string> parameters) {
			_context = context;
			_message = message;
			_object = obj;
		...
		/// <param name="context">The context to which the event is bound.</param>
		/// <param name="message">The simple message the event represents.</param>
		public Event(ISimpleProcessContext context, string message) : this(context, message, null) {}
